...
public class UserExtractionTest {
    ...
    @Test
    public void test004() {
        List<String> names = response.extract().path("find{it.status == 'inactive'}.name");
        System.out.println("------------------StartingTest---------------------------");
    ...
    @Test
    public void test010() {
       String email = response.extract().path("find{it.name == 'Chandak Chopra'}.email");
        System.out.println("------------------StartingTest---------------------------");
    ...
    @Test
    public void test011() {
        String gender = response.extract().path("find{it.id == 2272612}.gender");
        System.out.println("------------------StartingTest---------------------------");
